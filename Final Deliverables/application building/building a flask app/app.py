...
def load_model(file='C:/Users/Hyagiriva/OneDrive/Desktop/docs/nalaiya thiran/New folder/final1/Final Deliverables/Model Building/resale_model.sav'):
    return pickle.load(open(file, 'rb'))


@app.route('/')
def index():
    return render_template('templates/value.html')
